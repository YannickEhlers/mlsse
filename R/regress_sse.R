...
Regress_SSE <- function(a_data, nseq_SampleSizeToTest, c_learner, c_measurment, n_bootstraps, c_RegressionTarget){
  ...
  OutputObject <- list(Class = "Simulation Sample Size Estimation", MachineLearningType= "Regression" ,Learner=c_learner,Measurement=c_measurment,Bootstrap=n_bootstraps,SampleSizesTested=nseq_SampleSizeToTest,MeasuredMatrix=m_ResMatrix)
